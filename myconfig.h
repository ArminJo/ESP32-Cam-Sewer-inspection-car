...
#define CAM_NAME "ESP32-CAM-Robot-Car"
...
struct station stationList[] = {{"ESP32-CAM-ROBOT-CAR", "", true},{"mywlan", "wlan_password", true}};
 ...
 * it will be used for the AccessPoint ssid and password, which can be empty or more than 7 characters.
 * See the comments there for more. AP IP address is 192.168.4.1 by default
 *
 ...
 * - Most useful when used with a static network config, not all routers respect this setting
 * 
...
/*
 * Over The Air firmware updates can be disabled by uncommenting the following line
 */
// #define NO_OTA
 ...
 *
 */
// Initial Resolution, default SVGA
